            ...
            {(Object.keys(navItems) as NavCategory[]).map(category => {
                ...
                return (
                    <div key={category} className="mb-4">
                        <div className={cn(
                            "transition-all duration-300 overflow-hidden mb-2 px-3",
...
export function ClientLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className={cn(
            ...
            {!isMobile && (
                <aside className={cn(
                    "flex flex-col h-screen bg-sidebar text-sidebar-foreground transition-all duration-300 ease-in-out border-r border-sidebar-border z-50",
            ...
            <div className="flex flex-col flex-1 min-w-0">
                {/* ── Header ── */}
                <header className="h-16 flex items-center justify-between px-4 lg:px-8 bg-white dark:bg-card border-b border-border z-40 shadow-soft">
                        ...
                        {isMobile && (
                            <Sheet>
                                ...
                                <SheetContent side="left" className="p-0 w-[260px] bg-sidebar text-sidebar-foreground border-none">
                                    <SheetHeader className="h-16 flex items-center border-b border-white/10 px-4">
                                        <SheetTitle asChild>
                ...
                {/* ── Page Content ── */}
                <main className="flex-1 bg-[#f8f9fc] dark:bg-background/50 overflow-hidden relative">
