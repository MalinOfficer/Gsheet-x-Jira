          ...
          <div className="bg-white border-b border-gray-200 px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Ask questions about your case data in natural language.</p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                ...
                <button 
                  ...
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 bg-blue-500 hover:bg-blue-600 text-white text-sm rounded-md transition-colors shadow-sm hover:shadow disabled:bg-blue-300"
                >
              ...
              <div className="max-w-6xl mx-auto">
                {aiResponse && (
                  <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h2 className="text-lg font-semibold text-blue-800 mb-2">AI Answer:</h2>
                    <div className="text-blue-900 whitespace-pre-wrap">{aiResponse}</div>
                  </div>
                )}
                          ...
                          {categories.map(cat => (
                            <button
                              ...
                              className={cn('w-full text-left px-3 py-1.5 rounded text-sm transition-colors', {
                                'bg-blue-50 text-blue-700 font-medium': selectedCategory === cat,
                                'hover:bg-gray-50 text-gray-700': selectedCategory !== cat
                              })}
                            >
                        ...
                        <div className="space-y-1">
                          {['all', 'docx', 'xlsx', 'pdf'].map(type => (
                            <button
                              ...
                              className={cn('w-full text-left px-3 py-1.5 rounded text-sm transition-colors', {
                                'bg-blue-50 text-blue-700 font-medium': filterType === type,
                                'hover:bg-gray-50 text-gray-700': filterType !== type
                              })}
                            >
                    ...
                    <div className="col-span-9 space-y-3">
                      ...
                      {loading ? (
                        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
                          ...
                          <p className="text-sm text-gray-500">AI is analyzing the documents.</p>
                        </div>
